...
from ..WTForms.forms import Updateinfo_utilisateurForm
...
def utilisateur_dashboard():
    ...
    return render_template('profil.html',tickets=ticket, form=form)
